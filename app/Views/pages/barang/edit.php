...
<div class="row no-gutters">
    <div class="col">
        <div class="card shadow-sm">
            <div class="card-header card-title fw-bold text-center">Edit Stuffs</div>
            <div class="card-body">
                ...
                <div class="row mx-3">
                    <div class="col-auto">
                        ...
                        <div class="mt-4 text-center">
                            <form action="/dashboard/stuffs/update/<?= $id; ?>" method="post" class="ms-auto me-auto"
                    ...
                    <div class="col ms-5">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" id="spesifikasi" name="spesifikasi" autocomplete="off" cols="30"
                                rows="5"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sumber" id="sumber"
                                ...
                                <option value="<?= (old('sumber_dana')) ? old('sumber_dana') : $barang->sumber_dana; ?>"
                                    selected>
                                    <?= $barang->sumber_dana; ?>
                                </option>
                                <?php endif; ?>
