...
<body>
    <div class="wrapper">
        ...
        <div class="form bg-dark">
            ...
            <form action="/post-login" method="post" class="group">
                <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <div class="form-check mb-4">
                    <input class="form-check-input check" type="checkbox" name="remember" id="remember">
                    <label class="form-check-label text-white small" for="remember">
                        Remember Me!
                    </label>
                </div>
